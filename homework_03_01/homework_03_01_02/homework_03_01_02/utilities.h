...
namespace seq
{
	...
	*/
	...
	{
		/*
		* При совпадении искомого значения с значением элемента массива возвращает
		* указатель на первый элемент и элемент следующий запоследним элементом
		* последовательности одинаковых значенийЖ в противном случае - адрес памяти,
